...
class BuyersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create buyer" do
    assert_difference("Buyer.count") do
      post buyers_url, params: { buyer: { email: @buyer.email, full_name: @buyer.full_name, location: @buyer.location, tel: @buyer.tel } }
    end
  ...
  test "should update buyer" do
    patch buyer_url(@buyer), params: { buyer: { email: @buyer.email, full_name: @buyer.full_name, location: @buyer.location, tel: @buyer.tel } }
