...
class FarmersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create farmer" do
    assert_difference("Farmer.count") do
      post farmers_url, params: { farmer: { email: @farmer.email, full_name: @farmer.full_name, location: @farmer.location, tel: @farmer.tel } }
    end
  ...
  test "should update farmer" do
    patch farmer_url(@farmer), params: { farmer: { email: @farmer.email, full_name: @farmer.full_name, location: @farmer.location, tel: @farmer.tel } }
